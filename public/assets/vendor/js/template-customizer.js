!function (t, e) {
    ...
    return function () {
        ...
        return function () {
            ...
            var t = s(93379), e = s.n(t), o = s(38813), a = {insert: "head", singleton: !1},
                n = (e()(o.Z, a), o.Z.locals, s(32950)), l = s.n(n);
            ...
            var d = ["rtl", "style", "layoutType", "layoutMenuFlipped", "showDropdownOnHover", "layoutNavbarFixed", "layoutFooterFixed", "themes"],
                h = ["light", "dark"], m = document.documentElement.classList,
                p = document.getElementsByTagName("HTML")[0].getAttribute("data-theme") || 0,
                y = m.contains("dark-style") ? "dark" : "light",
                f = "rtl" === document.documentElement.getAttribute("dir"), g = !!m.contains("layout-menu-collapsed"),
                v = !!m.contains("layout-menu-flipped"), b = !!m.contains("layout-navbar-fixed"),
                _ = !!m.contains("layout-footer-fixed"),
                x = m.contains("layout-menu-offcanvas") ? "static-offcanvas" : m.contains("layout-menu-fixed") ? "fixed" : m.contains("layout-menu-fixed-offcanvas") ? "fixed-offcanvas" : "static",
                w = function () {
                    function t(e) {
                        var s = e.cssPath, i = e.themesPath, o = e.cssFilenamePattern, a = e.displayCustomizer,
                            ...
                            u = e.defaultMenuFlipped, m = e.defaultShowDropdownOnHover, w = e.defaultNavbarFixed,
                            S = e.defaultFooterFixed, z = e.styles, F = e.defaultStyle, k = e.availableThemes,
                            C = e.defaultTheme, A = e.pathResolver, T = e.onSettingsChange, N = e.lang;
                        if (function (t, e) {
                            if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                        }(this, t), !this._ssr) {
                            if (!window.Helpers) throw new Error("window.Helpers required.");
                            if (this.settings = {}, this.settings.cssPath = s, this.settings.themesPath = i, this.settings.cssFilenamePattern = o || "%name%.css", this.settings.displayCustomizer = void 0 === a || a, this.settings.controls = n || d, this.settings.defaultTextDir = "rtl" === l || f, this.settings.defaultLayoutType = r || x, this.settings.defaultMenuCollapsed = void 0 !== c ? c : g, this.settings.defaultMenuFlipped = void 0 !== u ? u : v, this.settings.defaultShowDropdownOnHover = void 0 !== m ? m : undefined, this.settings.defaultNavbarFixed = void 0 !== w ? w : b, this.settings.defaultFooterFixed = void 0 !== S ? S : _, this.settings.availableThemes = k || t.THEMES, this.settings.defaultTheme = this._getDefaultTheme(void 0 !== C ? C : p), this.settings.styles = z || h, this.settings.defaultStyle = F || y, this.settings.lang = N || "en", this.pathResolver = A || function (t) {
                                return t
                            ...
                            this.settings.onSettingsChange = "function" == typeof T ? T : function () {
                    ...
                    return e = t, s = [{
                        ...
                        key: "setTheme", value: function (t) {
                            ...
                            if (this._hasControls("themes")) {
                                ...
                                if (i) {
                                    ...
                                    this._loadStylesheets((o = {}, a = l, n = document.querySelector(".template-customizer-theme-css"), (a = u(a)) in o ? Object.defineProperty(o, a, {
                                        value: n,
                                        enumerable: !0,
                                        configurable: !0,
                                        writable: !0
                        ...
                        key: "_setup", value: function () {
                            ...
                            var i = this.container.querySelector(".template-customizer-open-btn"), o = function () {
                            ...
                            var a = this.container.querySelector(".template-customizer-close-btn"), n = function () {
                        ...
                        key: "_loadStylesheets", value: function (t, e) {
                            ...
                            function a(t, e, s) {
                                ...
                                var o, a = "sheet" in i ? "sheet" : "styleSheet",
                                    n = "sheet" in i ? "cssRules" : "rules", l = setTimeout((function () {
                    ...
                    }], s && c(e.prototype, s), i && c(e, i), Object.defineProperty(e, "prototype", {writable: !1}), t
                }();
            w.THEMES = [{name: "theme-default", title: "Default"}, {
                name: "theme-semi-dark",
                title: "Semi Dark"
            }, {name: "theme-bordered", title: "Bordered"}], w.LANGUAGES = {
                en: {

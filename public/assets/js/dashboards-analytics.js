...
!function () {
    let o, e, r, t, i, s;
    isDarkStyle ? (o = config.colors_dark.cardColor, e = config.colors_dark.headingColor, r = config.colors_dark.bodyColor, t = config.colors_dark.textMuted, s = config.colors_dark.borderColor) : (o = config.colors.cardColor, e = config.colors.headingColor, r = config.colors.bodyColor, t = config.colors.textMuted, s = config.colors.borderColor);
    const a = document.querySelector("#orderChart"), n = {
        ...
        fill: {
            type: "gradient",
            gradient: {shade: i, shadeIntensity: .8, opacityFrom: .8, opacityTo: .25, stops: [0, 85, 100]}
        },
    ...
    const l = document.querySelector("#totalRevenueChart"), d = {
        series: [{name: "2021", data: [18, 7, 15, 29, 18, 12, 9]}, {
            name: "2020",
    ...
    const c = document.querySelector("#growthChart"), p = {
        series: [78],
        labels: ["Growth"],
        ...
        plotOptions: {
            radialBar: {
                ...
                dataLabels: {
                    ...
                    }, value: {offsetY: -25, color: e, fontSize: "22px", fontWeight: "500", fontFamily: "Public Sans"}
                }
            }
        },
    ...
    const h = document.querySelector("#revenueChart"), f = {
    ...
    const b = document.querySelector("#profileReportChart"), u = {
        chart: {
            height: 80,
            type: "line",
            toolbar: {show: !1},
    ...
    const g = document.querySelector("#orderStatisticsChart"), y = {
            ...
            pie: {
                donut: {
                    ...
                    labels: {
                        ...
                        total: {
                            show: !0, fontSize: "0.8125rem", color: r, label: "Weekly", formatter: function (o) {
                                return "38%"
                            }
                        }
                    }
    ...
    const m = document.querySelector("#incomeChart"), w = {
        ...
        fill: {
            type: "gradient",
            gradient: {shade: i, shadeIntensity: .6, opacityFrom: .5, opacityTo: .25, stops: [0, 95, 100]}
        },
    ...
    const k = document.querySelector("#expensesOfWeek"), x = {
        series: [65],
            ...
            radialBar: {
                ...
                dataLabels: {
                    show: !0, name: {show: !1}, value: {
                        formatter: function (o) {
                            return "$" + parseInt(o)
                        }, offsetY: 5, color: "#697a8d", fontSize: "13px", show: !0
                    }
                }
            }
        },
